...
#define DDR_tRTP 8//10   /* 7.5ns READ to PRECHARGE command period. */
...
#define DDR_tRRD 10//8  /* ACTIVE bank A to ACTIVE bank B command period. */
...
#define DDR_tMINSR 138//6 /* Minimum Self-Refresh / tXSNR */
