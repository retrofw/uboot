...
#define DDRC_TIMING2_TRFC_BIT_JZ4760  12 /* AUTO-REFRESH command period. */
#define DDRC_TIMING2_TRFC_BIT_JZ4760B 24 /* AUTO-REFRESH command period. */
...
#define __slcd_set_data_8bit_x2() \
  ( REG_SLCD_CFG = (REG_SLCD_CFG & ~SLCD_CFG_DWIDTH_MASK) | SLCD_CFG_DWIDTH_8_x2 )
...
do {						\
	...
	REG_GPIO_PXPES(2) = 0x0fffffff;		\
        ...
        REG_GPIO_PXDS1S(2) = 0x0fffffff;         \
        REG_GPIO_PXDS2S(2) = 0x0fffffff;         \
} while (0)
...
#define __tcu_clear_counter_to_zero(n)   (REG_TCU_TCSR((n)) |= 0x400)
